...
class AlunniController
{
  ...
  public function create(Request $request, Response $response, $args){
    ...
    $mysqli_connection = new MySQLi('my_mariadb', 'root', 'ciccio', 'scuola');
    $result = $mysqli_connection->query("INSERT INTO `alunni`( `nome`, `cognome`) VALUES ( '" . $params['nome'] . "', '" . $params['cognome'] . "');");
    if($result){
      $results['message'] = "lo studente è stato inserito " ;
    }
    else{

      $results['message'] = "lo studente NON è stato inserito" ;
    }
